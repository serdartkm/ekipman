...
namespace ZimmetTakibi.Module.BusinessObjects
{
    [DomainComponent]
    [DefaultClassOptions]
    [XafDefaultProperty("PositionTitle"), NavigationItem(false)]
    ...
    [DomainLogic(typeof(IPosition))]
    public class PositionLogic
    {

        public static void OnSaving(IPosition pos)
        {

            pos.PositionTitle = pos.PositionTitle.ToUpper();
        }
    }

    // Implement a business logic for a domain component (http://documentation.devexpress.com/#Xaf/CustomDocument3364).
    //[DomainLogic(typeof(IPosition))]
    //public class IPositionLogic {
    //    public static string Get_CalculatedProperty(IPosition instance) {
    //        // A "Get_" method is executed when getting a target property value. The target property should be readonly.
    //        // Use this method to implement calculated properties.
    //        return "";
    //    }
    //    public static void AfterChange_PersistentProperty(IPosition instance) {
    //        // An "AfterChange_" method is executed after a target property is changed. The target property should not be readonly. 
    //        // Use this method to refresh dependant property values.
    //    }
    //    public static void AfterConstruction(IPosition instance) {
    //        // The "AfterConstruction" method is executed only once, after an object is created. 
    //        // Use this method to initialize new objects with default property values.
    //    }
    //    public static int SumMethod(IPosition instance, int val1, int val2) {
    ...
    //     XafTypesInfo.Instance.RegisterEntity("MyDomainComponent", typeof(IPosition));
